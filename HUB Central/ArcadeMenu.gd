...
class MiniGameData:
	...
	func _init(n: String, p: String, loc: String, s: bool, h: bool, sg: String, d: bool, cm: String, c: Color):
		name = n
		path = p
		location = loc
		is_scene = s
...
func _ready() -> void:
	...
	_minigames.append(MiniGameData.new("Crochetage",  "res://Scripts/MiniJeuCrochetage.tscn",       "res://MoyenAge/prison_moyen_age.tscn", true,  false, "done",          false, "", Color(0.8, 0.4, 0.2)))
	_minigames.append(MiniGameData.new("Marchandage", "res://Scripts/MiniJeuMarchandage.tscn",      "res://MoyenAge/magasin_moyen_age.tscn",true,  false, "done",          false, "", Color(0.9, 0.7, 0.2)))
	...
	_minigames.append(MiniGameData.new("Soleil",      "res://Scripts/MiniJeuSoleil.tscn",           "res://Present/parking.tscn",            true,  false, "done",          false, "", Color(0.9, 0.5, 0.1)))
	_minigames.append(MiniGameData.new("Tuyaux",      "res://Scripts/MiniJeuTuyau.tscn",            "res://Present/salleMachine.tscn",       true,  false, "done",          false, "", Color(0.2, 0.7, 0.4)))
	_minigames.append(MiniGameData.new("Câblage",     "res://Scripts/MiniJeuCablage.tscn",          "res://Present/salleElectricite.tscn",   true,  false, "done",          false, "", Color(0.6, 0.3, 0.9)))
	_minigames.append(MiniGameData.new("Hacking",     "res://Scripts/MiniJeuHacking.gd",            "res://Present/vestiaire.tscn",          false, false, "done",          false, "", Color(0.0, 0.8, 0.8)))
	_minigames.append(MiniGameData.new("Conduite",    "res://Futur/route.tscn",                     "",                                  true,  true,  "finished",      false, "", Color(0.1, 0.5, 0.9)))
	_minigames.append(MiniGameData.new("Lasers",      "res://Futur/fond_superette.tscn",            "",                                  true,  true,  "finished",      false, "MiniJeuTourelles", Color(0.5, 0.9, 0.2)))
...
func _on_minigame_selected(idx: int) -> void:
	...
	if use_full_scene:
		...
		if data.dual:
			...
			instance.connect(data.sig, Callable(self, "_on_minigame_done"))
...
func _on_minigame_done(_success := true) -> void:
	if _active_bg and is_instance_valid(_active_bg):
		if not _active_bg.is_queued_for_deletion():
			_active_bg.queue_free()
	_active_bg = null
