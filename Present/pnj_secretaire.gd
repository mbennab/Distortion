...
@export var npc_id: String = "npc_secretaire_present"
@export var npc_name: String = "Sophie"
@export var portrait_path: String = "res://art/Present/image-profile-secretaire.png"
