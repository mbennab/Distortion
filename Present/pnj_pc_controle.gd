...
@export var npc_id: String = "npc_pc_controle_normal"
@export var npc_name: String = "Technicien principal"
@export var portrait_path: String = "res://art/Present/pnj_pc_controle_dialogue.jpeg"
...
func _setup_bubble() -> void:
	...
	bubble.add_theme_color_override("font_color", Color(0.08, 0.08, 0.15, 1.0))
	bubble.custom_minimum_size = Vector2(240, 0)
	var bubble_style: StyleBoxFlat = StyleBoxFlat.new()
	bubble_style.bg_color = Color(0.85, 0.9, 0.98, 0.95)
	...
	bubble_style.border_color = Color(0.45, 0.6, 0.8, 0.65)
